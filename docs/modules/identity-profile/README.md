...
Update this README when auth providers/scopes, profile fields or paths, avatar handling, personal settings, FCM token storage, login/logout failure behavior, or profile security rules change.
