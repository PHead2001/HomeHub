...
| [Firebase Platform, Persistence, and Security](./firebase-platform/README.md) | Firebase bootstrap, rules, hosting, Functions | `src/lib/firebase.ts`, `firestore.rules`, `storage.rules`, `firebase.json`, `functions/` |
